...
class CodeEditorBase(QtWidgets.QPlainTextEdit):
    ...
    def __init__(self,*args, **kwds):
        ...
        if theme == "SubInsp":
            ...
            S  = {}
            S["Editor.text"] = "back:%s, fore:%s" % ("Black", lslightblue)
            S['Syntax.identifier'] = "fore:%s, bold:no, italic:no, underline:no" % lswhite
            S["Syntax.nonidentifier"] = "fore:%s, bold:no, italic:no, underline:no" % "#CC7833"
            S["Syntax.keyword"] = "fore:%s, bold:no, italic:no, underline:no" % "#CC7833"
 
            S["Syntax.functionname"] = "fore:%s, bold:no, italic:yes, underline:no" % lsorange
            S["Syntax.classname"] = "fore:%s, bold:yes, italic:no, underline:no" % lsorange
 
            S["Syntax.string"] = "fore:%s, bold:no, italic:no, underline:no" %"#66CC33"
            S["Syntax.unterminatedstring"] = "fore:%s, bold:no, italic:no, underline:dotted" % lsyellow
            S["Syntax.python.multilinestring"] = "fore:%s, bold:no, italic:no, underline:no" % lsyellow
 
            S["Syntax.number"] = "fore:%s, bold:no, italic:no, underline:no" % "#3387CC"
            S["Syntax.comment"] ="fore:%s, bold:no, italic:no, underline:no" % "#9933CC"
            S["Syntax.todocomment"] = "fore:%s, bold:yes, italic:no, underline:yes" % lsflashyblue
            S["Syntax.python.cellcomment"] = "fore:%s, bold:no, italic:no, underline:full" % "#9933CC"
 
            S["Editor.Long line indicator"] = "linestyle:solid, fore:%s" % lslightblue #lsnightblue
            S["Editor.Highlight current line"] = "back:%s" % lsdarkgrey
            S["Editor.Indentation guides"] = "linestyle:solid, fore:%s" % lsnightbluelight
            S["Editor.Line numbers"] = "back:%s, fore:%s" % (lsverydarkgrey, lsgrey)
            S["Editor.BreakPoints"] = 'fore:%s,back:%s' %(lsflashyyellow, lsdarkgrey)
        
            S["Syntax.openparen"] = "back:%s, fore:%s" % ("black", "white")
            S["Syntax.closeparen"] = "back:%s, fore:%s" % ("black", "white")
            S["Syntax.builtins"] = "fore:%s, bold:no, italic:no, underline:no" % lspink
